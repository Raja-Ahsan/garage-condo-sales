<section class="container-lux mt-12 md:mt-16 mb-4 md:mb-8" aria-labelledby="bentley-gallery-heading">
    <div class="flex items-end justify-between flex-wrap gap-6 mb-8 md:mb-10">
        <div class="min-w-0">
            <p class="eyebrow">Gallery</p>
            <h2 id="bentley-gallery-heading" class="section-title-lux mt-4">
                The Showcase
            </h2>
        </div>
    ...
    @if (empty($images))
        <div class="aspect-[21/9] grid place-items-center text-center p-8 bg-surface/40">
            <div>
                ...
                <p class="mt-3 text-lg text-muted-foreground">Bentley promotion imagery will appear here</p>
            </div>
        </div>
    @else
        @php
        ...
        <div class=" overflow-hidden group mb-3 sm:mb-4">
            <img
                src="{{ $hero['src'] }}"
                alt="{{ $hero['alt'] }}"
                loading="eager"
