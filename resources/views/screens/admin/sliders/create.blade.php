            ...
            <div class="col-xl-8 col-lg-10">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">New hero slide</h5>
                    </div>
                    <div class="card-body">
                        <form
                        ...
                        >
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <button type="submit" class="btn btn-primary" id="slider-submit-btn">Save slide</button>
...
<script>
    (function () {
        ...
        const form = document.getElementById('slider-create-form');
